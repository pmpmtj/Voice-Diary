...
# Update paths to use on_the_fly/config directory
CREDENTIALS_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 
                                'send_email', 'config', 'credentials_gmail.json')
TOKEN_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 
                        'send_email', 'config', 'token_gmail.pickle')
