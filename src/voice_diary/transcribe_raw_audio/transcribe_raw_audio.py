...
def load_config():
    ...
    try:
        ...
        config_path = PROJECT_ROOT / "project_modules_configs" / "config_transcribe_raw_audio" / "transcribe_for_diary_config.json"
...
def load_openai_config():
    ...
    try:
        # Use default config path
        config_path = PROJECT_ROOT / "project_modules_configs" / "config_transcribe_raw_audio" / "openai_transcribe_config.json"
